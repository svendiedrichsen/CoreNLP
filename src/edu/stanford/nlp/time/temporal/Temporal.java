...
public abstract class Temporal implements Cloneable, Serializable {
    ...
    protected SUTime.StandardTemporalType standardTemporalType;
    protected String timeLabel;

    // Duration after which the time is uncertain (what is there is an estimate)
    private Duration uncertaintyGranularity;
...
//      this.timeLabel = t.timeLabel;
  ...
  /*    TimeLabel tl = getTimeLabel();
    ...
    public void setUncertaintyGranularity(Duration uncertaintyGranularity) {
        this.uncertaintyGranularity = uncertaintyGranularity;
    }
    ...
    public void setStandardTemporalType(SUTime.StandardTemporalType standardTemporalType) {
        this.standardTemporalType = standardTemporalType;
    }
