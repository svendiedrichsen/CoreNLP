...
public class RelativeTime extends Time {
    ...
    private Time base = SUTime.TIME_REF;
        ...
        if (tempOp != null) {
            ...
            if (t != null) {
                ...
                if (t != null) {
                    t = t.addModApprox(mod, approx);
                    if (!this.equals(t)) {
                        return t.resolve(refTime, flags).getTime();
                    } else {
            ...
            return (groundedBase != null) ? groundedBase.addModApprox(mod, approx).getTime() : null;
        }
    }
    ...
    public Time intersect(Time t) {
        if (base == SUTime.TIME_REF || base == null) {
            if (t instanceof PartialTime && tempOp == SUTime.TemporalOp.OFFSET) {
