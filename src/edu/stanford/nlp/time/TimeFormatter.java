...
import edu.stanford.nlp.time.temporal.GroundedTime;
...
//        System.out.println();
    ...
    private static class TimeZoneComponent extends FormatComponent {
        ...
        private static void updateTimeZoneNames(Locale locale) {
            long time1 = new IsoDate(2013, 1, 1).getJodaTimeInstant().getMillis();
            long time2 = new IsoDate(2013, 6, 1).getJodaTimeInstant().getMillis();
